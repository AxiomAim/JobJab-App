import { concatMap, of, combineLatestWith, take } from 'rxjs';
 ...
 * ```
 */
function takeLatestFrom(observablesFactory) {
...
export { takeLatestFrom };
//# sourceMappingURL=ngxtension-take-latest-from.mjs.map
