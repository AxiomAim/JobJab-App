...
//     // _firebaseAuthV2Service = inject(forwardRef(() => FirebaseAuthV2Service));
...
//     //     // );
//     //     const colRef = collection(this.firestore, collectionPath);
//     //     const q = query(colRef, where('orgId', '==', this._firebaseAuthV2Service.loginUser().orgId));
//     //     const converter = {
...
//     public getAll<T extends BaseDatabaseModel>(collectionPath: string): Observable<T[]> {
//         const user = this._firebaseAuthV2Service.loginUser();
//         if (!user || !user.orgId) {
