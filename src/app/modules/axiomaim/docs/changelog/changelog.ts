            ...
            changes: [
                {
                    ...
                    list: [
                        ...
                        '(@axiomaim/fullscreen) Updated the fullscreen component to use the new Fullscreen API',
                    ],
                },
                {
                    type: 'Fixed',
            ...
            changes: [
                {
                    type: 'Breaking',
                    list: [
                        '(Standalone) Updated Axiomaim to standalone components',
            ...
            changes: [
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/confirmation-dialog) Fixed: Extra padding on the confirmation dialogs',
                    ],
                },
            ],
        },
            ...
            changes: [
                {
                    type: 'Breaking',
                    list: [
                        '(Dependencies) From this version up, Axiomaim will not be compatible with Legacy Angular Material components',
                        ...
                        '(.axiomaim-mat-textarea) Removed in favor of CSS :has selector, now textareas within "mat-form-field" components are detected automatically',
                        '(.axiomaim-mat-no-subscript) Removed in favor of \'subscriptSizing="dynamic"\' property of "mat-form-field"',
                    ],
                },
                {
                    type: 'Changed',
                    list: [
                        '(Dependencies) Updated Angular & Angular Material to v15.0.0',
                        '(Dependencies) Updated various other packages',
                        "(Dependencies) Removed ngx-markdown from the package.json, it still can be used within Axiomaim, it's a part of the effort to make releasing Axiomaim updates easier",
        ...
        // v16.0.0
        {
            ...
            changes: [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(AxiomaimVerticalNavigation) Fixed: Sticky positioning breaks inside a fixed positioned parent (Firefox)',
        ...
        // v15.2.0
        {
            ...
            changes: [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/tailwind/plugins/theming) Simplified the plugin and added more detailed comments',
        ...
        // v15.1.0
        {
            ...
            changes: [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/overrides/angular-material) mat-hint position is not working correctly on fields',
                    ],
                },
            ],
        },
            ...
            changes: [
                {
                    type: 'Added',
                    list: [
                        '(@axiomaim/navigation) Added "fragment" and "queryParams" support along with "preserveFragment" and "queryParamsHandling" on navigation items',
                        '(@axiomaim/overrides/quill) Added tooltip styles for better compatibility',
                        '(@axiomaim/services/platform) Added platform checker service',
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(AxiomaimDrawer) Updated the overlay and animation handling code for better stability',
                        '(@axiomaim/overrides/quill) Better scrolling for Quill editor',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/navigation) Collapse animation doesn"t work smoothly because of the parent"s margin',
                        '(@axiomaim/service/confirmation) Cleaned-up the dialog component',
            ...
            changes: [
                {
                    ...
                    list: [
                        ...
                        '(@axiomaim/navigation) Expose the width variables as css custom properties, so they can be overridden from the outside',
                        '(@axiomaim/drawer) Expose the width variable as a css custom property, so it can be overridden from the outside',
                        '(@axiomaim/masonry) Removed the unnecessary scss file',
                    ],
                },
                {
                    type: 'Fixed',
            ...
            changes: [
                {
                    type: 'Added',
                    list: [
                        '(AxiomaimLoadingBar) Added the AxiomaimLoadingBar component, its helper service and its interceptor',
                    ],
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(AxiomaimDateRange) BREAKING: Removed the AxiomaimDateRange component, alternative: https://github.com/fetrarij/ngx-daterangepicker-material',
                    ],
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/overrides/angular-material) Fixed: Normal border color of the text field overrides the invalid and focus border colors on dark themes',
                        "(@axiomaim/navigation) Don't need to use interpolation on scss variables anymore since Tailwind doesn't cause any problems with them anymore",
                    ],
                },
            ],
        },
        ...
        // v13.6.0
        {
            ...
            changes: [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation',
                    ],
                },
            ],
        },
            ...
            changes: [
                {
                    ...
                    list: [
                        ...
                        '(@axiomaim/theming) Better structuring on the themes.scss file',
                        '(@axiomaim) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                        '(apps/mailbox) Style improvements',
                        'Removed empty "styles" from component decorators',
                        'Decreased budget sizes since new Axiomaim is a lot smaller compared to the one with the old design',
                    ],
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@axiomaim/overrides) Quill editor is not styled correctly by default',
                        '(@axiomaim/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes: [
                {
                    type: 'Fixed',
                    list: [
                        '(axiomaim/confirmation) Confirmation dialog colors are not optimized for the Dark mode',
                    ],
                },
            ],
        },
            ...
            changes: [
                {
                    type: 'Added',
                    list: [
                        '(axiomaim/confirmation) A service to quickly configure and show confirmation dialogs',
                    ],
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(apps/contacts) Added confirmation to the "Delete contact" action using AxiomaimConfirmationService',
                        '(apps/ecommerce/inventory) Added confirmation to the "Delete product" action using AxiomaimConfirmationService',
                        '(apps/scrumboard) Added confirmation to the "Delete list" action using AxiomaimConfirmationService',
                        '(apps/tasks) Added confirmation to the "Delete task" action using AxiomaimConfirmationService',
                        '(ui/confirmation-dialog) Created a separate page for AxiomaimConfirmationService and put the example configurator in there for better visibility',
                        '(docs) Moved Axiomaim Components and Other Components into UI for better visibility and better categorization',
                    ],
                },
                {
                    type: 'Fixed',
            ...
            changes: [
                {
                    type: 'Added',
                    list: [
                        '(axiomaim/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip',
                    ],
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(axiomaim/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "axiomaim-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(axiomaim/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(axiomaim/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes: [
                {
                    type: 'Added',
                    list: [
                        '(axiomaim/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(axiomaim/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        "(axiomaim/navigation) First children of collapsable items don't have proper spacing at the top",
        ...
        // v13.0.3
        {
            ...
            changes: [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(axiomaim/autogrow) BREAKING: Removed "axiomaimAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes: [
                {
                    ...
                    list: [
                        ...
                        '(AxiomaimNavigation) Added support for new "isActiveMatchOptions" for Basic navigation items; https://github.com/angular/angular/pull/40303',
                    ],
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(AxiomaimNavigation) Added a generic return type for "getComponent" method on AxiomaimNavigationService',
                        '(AxiomaimNavigation) Use the generic return type for "getComponent"',
                        '(axiomaim) Fixed barrel exports',
            ...
            changes: [
                {
                    ...
                    list: [
                        ...
                        '(axiomaim/masonry) Added a component for creating fast Masonry-like layouts',
                    ],
                },
                {
                    type: 'Changed',
            ...
            changes: [
                {
                    ...
                    list: [
                        ...
                        '(axiomaim/fullscreen) Added fullscreen toggle component',
                    ],
                },
                {
                    type: 'Changed',
            ...
            changes: [
                {
                    type: 'Added',
                    list: [
                        "This is the new major version of the Axiomaim and it's completely different from previous versions with no upgrade path",
