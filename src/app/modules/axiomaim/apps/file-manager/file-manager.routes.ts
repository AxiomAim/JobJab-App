...
import { FileManagerDetailsComponent } from 'app/modules/axiomaim/apps/file-manager/details/details.component';
import { FileManagerComponent } from 'app/modules/axiomaim/apps/file-manager/file-manager.component';
import { FileManagerService } from 'app/modules/axiomaim/apps/file-manager/file-manager.service';
import { FileManagerListComponent } from 'app/modules/axiomaim/apps/file-manager/list/list.component';
