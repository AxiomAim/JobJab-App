...
import { MailboxComposeComponent } from 'app/modules/axiomaim/apps/mailbox/compose/compose.component';
import { labelColorDefs } from 'app/modules/axiomaim/apps/mailbox/mailbox.constants';
import { MailboxService } from 'app/modules/axiomaim/apps/mailbox/mailbox.service';
import {
    MailFilter,
    MailFolder,
    MailLabel,
} from 'app/modules/axiomaim/apps/mailbox/mailbox.types';
...
@Component({
    ...
    imports: [MatButtonModule, MatIconModule, AxiomaimVerticalNavigationComponent],
})
export class MailboxSidebarComponent implements OnInit, OnDestroy {
    ...
    private _filtersMenuData: AxiomaimNavigationItem[] = [];
    private _foldersMenuData: AxiomaimNavigationItem[] = [];
    private _labelsMenuData: AxiomaimNavigationItem[] = [];
    private _otherMenuData: AxiomaimNavigationItem[] = [];
    ...
    private _generateFoldersMenuLinks(): void {
        ...
        this.folders.forEach((folder) => {
            ...
            const menuItem: AxiomaimNavigationItem = {
                id: folder.id,
                title: folder.title,
                type: 'basic',
                icon: folder.icon,
