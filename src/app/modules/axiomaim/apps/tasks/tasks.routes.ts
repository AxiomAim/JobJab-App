...
import { TasksDetailsComponent } from 'app/modules/axiomaim/apps/tasks/details/details.component';
import { TasksListComponent } from 'app/modules/axiomaim/apps/tasks/list/list.component';
import { TasksComponent } from 'app/modules/axiomaim/apps/tasks/tasks.component';
