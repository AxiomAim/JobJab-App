...
import {
    ...
    MailFolder,
    MailLabel,
} from 'app/modules/davesa/csv/protocols/mailbox.types';
import {
    BehaviorSubject,
    Observable,
    map,
...
export class ProtocolsService {
    ...
    getFilters(): Observable<any> {
        return this._httpClient
            .get<MailFilter[]>('api/csv/protocols/filters')
            .pipe(
                tap((response: any) => {
    ...
    getFolders(): Observable<any> {
        return this._httpClient
            .get<MailFolder[]>('api/csv/protocols/folders')
            .pipe(
                tap((response: any) => {
    ...
    getLabels(): Observable<any> {
        return this._httpClient
            .get<MailLabel[]>('api/csv/protocols/labels')
            .pipe(
                tap((response: any) => {
    ...
    getMailsByFilter(filter: string, page: string = '1'): Observable<any> {
        ...
        return this._httpClient
            .get<Mail[]>('api/csv/protocols/mails', {
                params: {
                    filter,
                    page,
                },
    ...
    addLabel(label: MailLabel): Observable<any> {
        return this.labels$.pipe(
            ...
            switchMap((labels) =>
                this._httpClient
                    .post<MailLabel>('api/csv/protocols/label', { label })
                    .pipe(
                        map((newLabel) => {
    ...
    updateLabel(id: string, label: MailLabel): Observable<any> {
        return this.labels$.pipe(
            ...
            switchMap((labels) =>
                this._httpClient
                    .patch<MailLabel>('api/csv/protocols/label', {
                        id,
                        label,
                    })
                    .pipe(
    ...
    deleteLabel(id: string): Observable<any> {
        return this.labels$.pipe(
            ...
            switchMap((labels) =>
                this._httpClient
                    .delete('api/csv/protocols/label', { params: { id } })
                    .pipe(
                        map((isDeleted: any) => {
