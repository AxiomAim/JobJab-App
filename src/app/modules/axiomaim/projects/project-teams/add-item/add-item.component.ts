...
@Component({
    selector: 'project-teams-add-item',
...
export class ProjectTeamsAddItemComponent implements OnInit, AfterViewInit, OnDestroy {
    _firebaseAuthV2Service = inject(FirebaseAuthV2Service);
    _productsV2Service = inject(ProjectTeamsV2Service);
