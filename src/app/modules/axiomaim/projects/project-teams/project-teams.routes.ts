...
import { ProjectTeamsDetailsComponent } from './details/details.component';
...
const projectTeamResolver = (
    ...
    const _productsV2Service = inject(ProjectTeamsV2Service);
...
const canDeactivateUsersDetails = (
    component: ProjectTeamsDetailsComponent,
...
export default [
    {
        ...
        children: [
            {
                path: '',
                component: ProjectTeamsListComponent,
                resolve: {
                    projectTeams: () => inject(ProjectTeamsV2Service).getAll(),
                },
                children: [
                    {
                        path: ':id',
