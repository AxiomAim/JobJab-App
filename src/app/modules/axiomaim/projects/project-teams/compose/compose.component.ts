...
import { ProjectTeam, ProjectTeamModel } from '../project-teams.model';
...
export class ProductsComposeComponent implements OnInit {
    _usersV2Service = inject(ProjectTeamsV2Service);
    ...
    user: ProjectTeam = ProjectTeamModel.emptyDto();    
    private _user: BehaviorSubject<ProjectTeam | null> = new BehaviorSubject(
        null
    );
    get userRole$(): Observable<ProjectTeam> {
