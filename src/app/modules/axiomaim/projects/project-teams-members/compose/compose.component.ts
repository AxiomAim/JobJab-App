...
import { ProjectTeamMember, ProjectTeamMemberModel } from '../project-teams-members.model';
...
export class ProductsComposeComponent implements OnInit {
    _usersV2Service = inject(ProjectTeamsMembersV2Service);
    ...
    user: ProjectTeamMember = ProjectTeamMemberModel.emptyDto();    
    private _user: BehaviorSubject<ProjectTeamMember | null> = new BehaviorSubject(
        null
    );
    get userRole$(): Observable<ProjectTeamMember> {
