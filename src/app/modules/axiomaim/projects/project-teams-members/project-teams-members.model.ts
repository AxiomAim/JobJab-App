...
export class ProjectTeamMemberModel implements BaseDto {
    constructor(
        id: string,
        orgId: string,
        type: string,
    ...
    public static toDto(dto: ProjectTeamMember): ProjectTeamMember {
    ...
    public static emptyDto():ProjectTeamMember {
        let date: any = new Date().toISOString();
        return {
            id: uuidv4().toString(),
            orgId: '',
...
export interface ProjectTeamMember  extends BaseDto {
    id: string;
    orgId: string;
    type: string,
    name: string;
