...
import { ProjectTeamsMembersAddItemComponent } from '../add-item/add-item.component';

@Component({
    selector: 'project-teams-members-list',
    ...
    imports: [
        ...
        AsyncPipe,
        I18nPluralPipe,
        ProjectTeamsMembersAddItemComponent
    ],
})
export class ProjectTeamsMembersListComponent implements OnInit, OnDestroy {
    _productsV2Service = inject(ProjectTeamsMembersV2Service);
    @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;

    private _products: BehaviorSubject<ProjectTeamMember[] | null> = new BehaviorSubject(
        null
    );
    get products$(): Observable<ProjectTeamMember[]> {
    ...
    selectedProduct: ProjectTeamMember;
    ...
    ngOnInit(): void {
        ...
        this.products$
            ...
            .subscribe((products: ProjectTeamMember[]) => {
                // Update the counts
        ...
        this.product$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((product: ProjectTeamMember) => {
