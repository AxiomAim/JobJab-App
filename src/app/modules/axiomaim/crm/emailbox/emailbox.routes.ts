...
import { MailboxDetailsComponent } from 'app/modules/axiomaim/apps/mailbox/details/details.component';
import { MailboxEmptyDetailsComponent } from 'app/modules/axiomaim/apps/mailbox/empty-details/empty-details.component';
import { MailboxListComponent } from 'app/modules/axiomaim/apps/mailbox/list/list.component';
import { MailboxComponent } from 'app/modules/axiomaim/apps/mailbox/mailbox.component';
import { MailboxService } from 'app/modules/axiomaim/apps/mailbox/mailbox.service';
import { MailboxSettingsComponent } from 'app/modules/axiomaim/apps/mailbox/settings/settings.component';
