...
import { Customer, CustomerModel } from '../customers.model';
...
export class ProductsComposeComponent implements OnInit {
    _usersV2Service = inject(CustomersV2Service);
    ...
    user: Customer = CustomerModel.emptyDto();    
    private _user: BehaviorSubject<Customer | null> = new BehaviorSubject(
        null
    );
    get userRole$(): Observable<Customer> {
