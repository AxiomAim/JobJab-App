...
import { Contact, ContactModel } from '../contacts.model';
...
export class ProductsComposeComponent implements OnInit {
    _usersV2Service = inject(ContactsV2Service);
    ...
    user: Contact = ContactModel.emptyDto();    
    private _user: BehaviorSubject<Contact | null> = new BehaviorSubject(
        null
    );
    get userRole$(): Observable<Contact> {
