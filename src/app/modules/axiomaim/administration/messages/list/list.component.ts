...
export class MessagesListComponent implements OnInit, OnDestroy {
    ...
    private _messages: BehaviorSubject<Message[] | null> = new BehaviorSubject(
        null
    );
    ...
    ngOnInit(): void {
        // Get the messages
        this._messages.next(this._messagesV2Service.messages());
        this.messages$
        ...
        // Get the product
        this._message.next(this._messagesV2Service.message());
        this.message$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((product: Message) => {
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                    // Search
                    this._messagesV2Service.search(query)
                )
            )
            .subscribe((resProducts) => {
                this._messages.next(resProducts);
            });
