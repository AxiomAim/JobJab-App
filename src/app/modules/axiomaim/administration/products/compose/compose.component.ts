...
export class ProductsComposeComponent implements OnInit {
    _usersV2Service = inject(ProductsV2Service);
    ...
    user: Product = ProductModel.emptyDto();    
    private _user: BehaviorSubject<Product | null> = new BehaviorSubject(
        null
    );
    get userRole$(): Observable<Product> {
