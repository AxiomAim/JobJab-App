...
import { TechniciansDetailsComponent } from './details/details.component';
...
const technicianResolver = (
    ...
    const _productsV2Service = inject(TechniciansV2Service);
...
const canDeactivateUsersDetails = (
    component: TechniciansDetailsComponent,
        ...
        children: [
            {
                ...
                resolve: {
                    users: () => inject(TechniciansV2Service).getAll(),
                },
                children: [
                    {
                        path: ':id',
