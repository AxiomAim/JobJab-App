...
export class TechnicianModel implements BaseDto {
    constructor(
        id: string,
        orgId: string,
        type: string,
    ...
    public static toDto(dto: Technician): Technician {
    ...
    public static emptyDto():Technician {
        let date: any = new Date().toISOString();
        return {
            id: uuidv4().toString(),
            orgId: '',
...
export interface Technician  extends BaseDto {
    id: string;
    orgId: string;
    type: string,
    name: string;
