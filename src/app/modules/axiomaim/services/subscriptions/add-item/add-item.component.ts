...
@Component({
    selector: 'subscriptions-add-item',
...
export class SubscriptionsAddItemComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    _billingCyclesService = inject(BillingCyclesService);
     ...
     */
    ngOnInit(): void {
        this.billingCycles$ = this._billingCyclesService.billingCycles$;
        this.setFormGroup();
    }
