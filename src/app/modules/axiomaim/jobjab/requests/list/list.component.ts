...
import { RequestsAddItemComponent } from '../add-item/add-item.component';
import { MatChipsModule } from '@angular/material/chips';
import { PhonePipe } from '@axiomaim/pipes/phone.pipe';
import { RequestsAddFormComponent } from '../add-form/add-form.component';
...
export class RequestsListComponent implements OnInit, OnDestroy {
    _requestsV2Service = inject(RequestsV2Service);
    ...
    ngOnInit(): void {
        ...
        this.selectedItem = this._requestsV2Service.request();
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                    // Search
                    this._requestsV2Service.search(query)
                )
            )
            .subscribe((resUsers) => {
                console.log('searchUsers', this._requestsV2Service.requests());
