...
export class UsersEditItemComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    _contactsV2Service = inject(RequestsV2Service);
     ...
     * Sned email to new contact to set up their password
     * refreshes all contacts in service
     * closes the drawer 
     */
