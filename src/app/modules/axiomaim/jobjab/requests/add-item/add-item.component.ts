...
export class RequestsAddItemComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public newContact: Request = RequestModel.emptyDto();
    ...
    setupForm() {
        this.newContact = RequestModel.emptyDto();
    ...
    private resetForm(): void {
        ...
        this.updateFormData(RequestModel.emptyDto());
    ...
    async onSubmit() {
        ...
        try {
            ...
            await this._requestsV2Service.createItem(this.newContact);
            await this._requestsV2Service.getAll();
            ...
            if(this.external){
                ...
                this.close();
                // this._router.navigate(['/crm/requests']);
            }
        } finally {
    ...
    sendContact() {
        this.requestCreated.emit(this.newContact);
        this.close();
    }
