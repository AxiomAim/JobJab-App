...
export class JobsAddItemComponent implements OnInit, AfterViewInit, OnDestroy {
    @Input() btnIcon: string = 'mat_outline:add';
    @Input() btnTitle: string = 'Add';
    @Input() external: boolean = false;
    @Output() jobCreated: EventEmitter<Job> = new EventEmitter<Job>();
    ...
    public newContact: Job = JobModel.emptyDto();
    ...
    setupForm() {
        this.newContact = JobModel.emptyDto();
    ...
    private resetForm(): void {
        ...
        this.updateFormData(JobModel.emptyDto());
    ...
    async onSubmit() {
        ...
        try {
            ...
            await this._jobsV2Service.createItem(this.newContact);
            await this._jobsV2Service.getAll();
            ...
            if(this.external){
                ...
                this.close();
                // this._router.navigate(['/crm/jobs']);
            }
        } finally {
    ...
    sendContact() {
        this.jobCreated.emit(this.newContact);
        this.close();
    }
