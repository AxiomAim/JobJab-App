...
export class FormsListComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.selectedItem = this._formsV2Service.form();
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                    // Search
                    this._formsV2Service.search(query)
                )
            )
            .subscribe((resUsers) => {
                console.log('searchUsers', this._formsV2Service.forms());
