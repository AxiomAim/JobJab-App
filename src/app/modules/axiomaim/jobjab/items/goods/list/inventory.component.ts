...
import { GoodsAddItemComponent } from '../add-item/add-item.component';
    ...
    implements OnInit, AfterViewInit, OnDestroy
{
    ...
    products$: Observable<GoodProduct[]>;
    ...
    selectedProduct: GoodProduct | null = null;
    ...
    constructor(
        ...
        private _inventoryService: GoodsService
    ) {}
    ...
    ngOnInit(): void {
        ...
        this._inventoryService.categories$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((categories: GoodCategory[]) => {
        ...
        this._inventoryService.pagination$
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((pagination: GoodPagination) => {
