...
import { QueriesAddItemComponent } from '../add-item/add-item.component';
import { MatChipsModule } from '@angular/material/chips';
import { PhonePipe } from '@axiomaim/pipes/phone.pipe';

@Component({
    selector: 'queries-list',
    ...
    imports: [
        ...
        // AsyncPipe,
        I18nPluralPipe,
        QueriesAddItemComponent,
        MatChipsModule,
        PhonePipe
    ],
})
export class QueriesListComponent implements OnInit, OnDestroy {
    _queriesV2Service = inject(QueriesV2Service);
    ...
    ngOnInit(): void {
        ...
        this.selectedItem = this._queriesV2Service.query();
        ...
        this.searchInputControl.valueChanges
            .pipe(
                ...
                switchMap((query) =>
                    // Search
                    this._queriesV2Service.search(query)
                )
            )
            .subscribe((resUsers) => {
                console.log('searchUsers', this._queriesV2Service.queries());
