...
import {
    ...
    Label,
    List,
} from 'app/modules/axiomaim/jobjab/job-board/job-board.models';
import {
    BehaviorSubject,
    Observable,
    map,
...
export class JobBoardService {
    ...
    getBoards(): Observable<Board[]> {
        return this._httpClient.get<Board[]>('api/jobjab/job-board/boards').pipe(
    ...
    getBoard(id: string): Observable<Board> {
        return this._httpClient
            .get<Board>('api/jobjab/job-board/board', { params: { id } })
            .pipe(
    ...
    createBoard(board: Board): Observable<Board> {
        return this.boards$.pipe(
            ...
            switchMap((boards) =>
                this._httpClient
                    .put<Board>('api/jobjab/job-board/board', { board })
                    .pipe(
                        map((newBoard) => {
    ...
    updateBoard(id: string, board: Board): Observable<Board> {
        return this.boards$.pipe(
            ...
            switchMap((boards) =>
                this._httpClient
                    .patch<Board>('api/jobjab/job-board/board', {
                        id,
                        board,
                    })
                    .pipe(
    ...
    deleteBoard(id: string): Observable<boolean> {
        return this.boards$.pipe(
            ...
            switchMap((boards) =>
                this._httpClient
                    .delete('api/jobjab/job-board/board', { params: { id } })
                    .pipe(
    ...
    createList(list: List): Observable<List> {
        return this._httpClient
            .post<List>('api/jobjab/job-board/board/list', { list })
            .pipe(
    ...
    updateList(list: List): Observable<List> {
        return this._httpClient
            .patch<List>('api/jobjab/job-board/board/list', { list })
            .pipe(
                map((response) => new List(response)),
                tap((updatedList) => {
                    // Get the board value
    ...
    updateLists(lists: List[]): Observable<List[]> {
        return this._httpClient
            .patch<List[]>('api/jobjab/job-board/board/lists', { lists })
            .pipe(
    ...
    deleteList(id: string): Observable<boolean> {
        return this._httpClient
            .delete<boolean>('api/jobjab/job-board/board/list', {
                params: { id },
            })
            .pipe(
                tap((isDeleted) => {
    ...
    createCard(card: Card): Observable<Card> {
        return this._httpClient
            .put<Card>('api/jobjab/job-board/board/card', { card })
            .pipe(
    ...
    updateCard(id: string, card: Card): Observable<Card> {
        return this.board$.pipe(
            ...
            switchMap((board) =>
                this._httpClient
                    .patch<Card>('api/jobjab/job-board/board/card', {
                        id,
                        card,
                    })
                    .pipe(
    ...
    updateCards(cards: Card[]): Observable<Card[]> {
        return this._httpClient
            .patch<Card[]>('api/jobjab/job-board/board/cards', { cards })
            .pipe(
    ...
    deleteCard(id: string): Observable<boolean> {
        return this.board$.pipe(
            ...
            switchMap((board) =>
                this._httpClient
                    .delete('api/jobjab/job-board/board/card', {
                        params: { id },
                    })
                    .pipe(
                        map((isDeleted: boolean) => {
    ...
    createLabel(label: Label): Observable<Label> {
        return this.board$.pipe(
            ...
            switchMap((board) =>
                this._httpClient
                    .post<Label>('api/jobjab/job-board/board/label', { label })
                    .pipe(
                        map((newLabel) => {
    ...
    updateLabel(id: string, label: Label): Observable<Label> {
        return this.board$.pipe(
            ...
            switchMap((board) =>
                this._httpClient
                    .patch<Label>('api/jobjab/job-board/board/label', {
                        id,
                        label,
                    })
                    .pipe(
    ...
    deleteLabel(id: string): Observable<boolean> {
        return this.board$.pipe(
            ...
            switchMap((board) =>
                this._httpClient
                    .delete('api/jobjab/job-board/board/label', {
                        params: { id },
                    })
                    .pipe(
                        map((isDeleted: boolean) => {
    ...
    search(query: string): Observable<Card[] | null> {
        ...
        return this._httpClient.get<Card[] | null>(
            'api/jobjab/job-board/board/search',
            { params: { query } }
        );
    }
}
