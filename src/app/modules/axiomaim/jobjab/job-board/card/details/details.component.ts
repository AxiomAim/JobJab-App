...
@Component({
    selector: 'job-board-card-details',
...
export class JobBoardCardDetailsComponent implements OnInit, OnDestroy {
     ...
     */
    constructor(
        public matDialogRef: MatDialogRef<JobBoardCardDetailsComponent>,
    ...
    ngOnInit(): void {
        ...
        this.cardForm.valueChanges
            ...
            .subscribe((value) => {
                ...
                this._jobBoardService.updateCard(value.id, value).subscribe();
