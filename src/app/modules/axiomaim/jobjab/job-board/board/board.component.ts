...
import { JobBoardBoardAddCardComponent } from './add-card/add-card.component';
import { JobBoardBoardAddListComponent } from './add-list/add-list.component';

@Component({
    selector: 'job-board-board',
    ...
    imports: [
        ...
        MatMenuModule,
        NgClass,
        JobBoardBoardAddCardComponent,
        JobBoardBoardAddListComponent,
        RouterOutlet,
        DatePipe,
    ],
})
export class JobBoardBoardComponent implements OnInit, OnDestroy {
    board: Board;
    ...
    addList(title: string): void {
        ...
        // Save the list
        this._jobBoardService.createList(list).subscribe();
    }
    ...
    updateListTitle(event: any, list: List): void {
        ...
        // Update the list
        this._jobBoardService.updateList(list).subscribe();
    }
    ...
    deleteList(id): void {
        ...
        confirmation.afterClosed().subscribe((result) => {
            ...
            if (result === 'confirmed') {
                // Delete the list
                this._jobBoardService.deleteList(id).subscribe();
            }
        });
    }
    ...
    addCard(list: List, title: string): void {
        ...
        // Save the card
        this._jobBoardService.createCard(card).subscribe();
    }
    ...
    listDropped(event: CdkDragDrop<List[]>): void {
        ...
        // Update the lists
        this._jobBoardService.updateLists(updated).subscribe();
    }
    ...
    cardDropped(event: CdkDragDrop<Card[]>): void {
        ...
        // Update the cards
        this._jobBoardService.updateCards(updated).subscribe();
    }
