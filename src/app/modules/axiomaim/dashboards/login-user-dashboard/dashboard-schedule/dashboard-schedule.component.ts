...
export class DashboardScheduleComponent  {
  ...
  public getWeatherImage(value: Date): string {
    switch (value.getDay()) {
      case 0:
        return '<img class="weather-image" src="https://ej2.syncfusion.com/angular/demos/assets/schedule/images/weather-clear.svg" alt="Clear Weather"/>';
      case 1:
        return '<img class="weather-image" src="https://ej2.syncfusion.com/angular/demos/assets/schedule/images/weather-clouds.svg" alt="Clouds Weather"/>';
      case 2:
        return '<img class="weather-image" src="https://ej2.syncfusion.com/angular/demos/assets/schedule/images/weather-rain.svg" alt="Rain Weather"/>';
      case 3:
        return '<img class="weather-image" src="https://ej2.syncfusion.com/angular/demos/assets/schedule/images/weather-clouds.svg" alt="Clouds Weather"/>';
      case 4:
        return '<img class="weather-image" src="https://ej2.syncfusion.com/angular/demos/assets/schedule/images/weather-rain.svg" alt="Rain Weather"/>';
