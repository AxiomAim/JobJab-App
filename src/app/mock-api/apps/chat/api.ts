...
export class ChatMockApi {
    ...
    registerHandlers(): void {
        ...
        // @ Chats - GET
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService.onGet('api/apps/chat/chats').reply(() => {
            // Clone the chats
        ...
        // @ Contacts - GET
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService.onGet('api/apps/chat/contacts').reply(() => {
            // Clone the contacts
        ...
        // @ Profile - GET
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService.onGet('api/apps/chat/profile').reply(() => {
            // Clone the profile
