...
import { AxiomaimMockApiUtils } from '@axiomaim/lib/mock-api/mock-api.utils';
import {
    tags as tagsData,
    tasks as tasksData,
    ...
    registerHandlers(): void {
        ...
        this._axiomaimMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = AxiomaimMockApiUtils.guid();
        ...
        // @ Tasks - GET
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService.onGet('api/apps/tasks/all').reply(() => {
            // Clone the tasks
