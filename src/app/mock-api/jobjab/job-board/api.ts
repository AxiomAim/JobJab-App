...
import {
    ...
    jobBoardLists as jobBoardListsData,
    jobBoards as jobBoardsData,
} from 'app/mock-api/jobjab/job-board/data';
import { assign, cloneDeep } from 'lodash-es';

@Injectable({ providedIn: 'root' })
export class JobBoardMockApi {
    // Private
    ...
    private _jobBoardLists: any[] = jobBoardListsData;
    private _jobBoards: any[] = jobBoardsData;
    ...
    registerHandlers(): void {
        ...
        this._axiomaimMockApiService
            .onGet('api/jobjab/job-board/boards')
            .reply(({ request }) => {
                // Clone the boards
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onGet('api/jobjab/job-board/board')
            .reply(({ request }) => {
                // Get the id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPost('api/jobjab/job-board/board/list')
            .reply(({ request }) => {
                // Get the list
                const newList = cloneDeep(request.body.list);

                // Generate a new GUID
                newList.id = AxiomaimMockApiUtils.guid();
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPatch('api/jobjab/job-board/board/list')
            .reply(({ request }) => {
                // Get the list
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPatch('api/jobjab/job-board/board/lists')
            .reply(({ request }) => {
                // Get the lists
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onDelete('api/jobjab/job-board/board/list')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPut('api/jobjab/job-board/board/card')
            .reply(({ request }) => {
                // Get the card
                const newCard = cloneDeep(request.body.card);

                // Generate a new GUID
                newCard.id = AxiomaimMockApiUtils.guid();
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPatch('api/jobjab/job-board/board/card')
            .reply(({ request }) => {
                // Get the id and card
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPatch('api/jobjab/job-board/board/cards')
            .reply(({ request }) => {
                // Get the cards
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onDelete('api/jobjab/job-board/board/card')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPatch('api/jobjab/job-board/board/card/positions')
            .reply(({ request }) => {
                // Get the cards
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onGet('api/jobjab/job-board/board/labels')
            .reply(({ request }) => {
                // Get the board id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPut('api/jobjab/job-board/board/label')
            .reply(({ request }) => {
                // Get the label
                const newLabel = cloneDeep(request.body.label);

                // Generate a new GUID
                newLabel.id = AxiomaimMockApiUtils.guid();
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPatch('api/jobjab/job-board/board/label')
            .reply(({ request }) => {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onDelete('api/jobjab/job-board/board/label')
            .reply(({ request }) => {
                // Get the id
                const id = request.params.get('id');
