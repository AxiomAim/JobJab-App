...
export const defaultNavigation: AxiomaimNavigationItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                id: 'user-interface.axiomaim-components',
                title: 'Axiomaim Components',
                type: 'basic',
                icon: 'heroicons_outline:square-3-stack-3d',
                link: '/ui/axiomaim-components',
            },
            {
...
export const compactNavigation: AxiomaimNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
        tooltip: 'Dashboards',
...
export const futuristicNavigation: AxiomaimNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'DASHBOARDS',
        type: 'group',
...
export const horizontalNavigation: AxiomaimNavigationItem[] = [
    {
        id: 'dashboards',
        title: 'Dashboards',
        type: 'group',
