...
import { userRoles as userRolesData } from 'app/mock-api/common/user-roles/data';
import { assign, cloneDeep } from 'lodash-es';

@Injectable({ providedIn: 'root' })
export class UserRolesMockApi {
    private _userRoles: UserRole[] = userRolesData;
    ...
    registerHandlers(): void {
        ...
        this._axiomaimMockApiService
            .onGet('api/common/user-roles')
            .reply(() => [200, cloneDeep(this._userRoles)]);

        // -----------------------------------------------------------------------------------------------------
        // @ Messages - POST
        // -----------------------------------------------------------------------------------------------------
        this._axiomaimMockApiService
            .onPost('api/common/user-roles')
            .reply(({ request }) => {
                // Get the message
                ...
                this._userRoles.unshift(newMessage);
