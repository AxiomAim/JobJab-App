...
@Component({
  selector: "address-lookup-sjs",
  templateUrl: "./address-lookup-sjs.component.html",
  styleUrls: [ "./address-lookup-sjs.component.scss" ],
    standalone: true,
  imports: [
...
export class AddressLookupSjsComponent extends QuestionAngular<QuestionColorPickerModel> {
address: FormControl = new FormControl('');
  handleChange($event: selectedOption) {
    this.model.value = $event.color.hex;
  }
}
AngularComponentFactory.Instance.registerComponent(CUSTOM_TYPE + "-question", AddressLookupSjsComponent);
