...
@Component({
    selector: 'customers-menu',
    templateUrl: './customers-menu.component.html',
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'customers-menu',
    imports: [
        MatButtonModule, 
        MatMenuModule, 
        MatIconModule,
...
export class CustomersMenuComponent implements OnInit, OnDestroy {
