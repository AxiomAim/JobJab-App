...
import { AxiomaimConfig, AxiomaimConfigService } from '@axiomaim/services/config';
...
import { AXIOMAIM_VERSION } from '@axiomaim/version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _axiomaimPlatformService: AxiomaimPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._axiomaimMediaWatcherService.onMediaQueryChange$([
        ...
        this._axiomaimConfigService.config$
            ...
            .subscribe((config: AxiomaimConfig) => {
                // Store the config
                this.config = config;
        ...
        this._renderer2.addClass(
            this._document.body,
            this._axiomaimPlatformService.osName
        );
    }
