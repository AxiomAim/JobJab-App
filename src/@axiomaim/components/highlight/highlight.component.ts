...
import { AxiomaimHighlightService } from '@axiomaim/components/highlight/highlight.service';

@Component({
    selector: 'textarea[axiomaim-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'axiomaimHighlight',
    imports: [NgClass],
})
export class AxiomaimHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _axiomaimHighlightService = inject(AxiomaimHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._axiomaimHighlightService.highlight(this.code, this.lang)
        );
