...
@Component({
    selector: 'axiomaim-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => AxiomaimVerticalNavigationCollapsableItemComponent),
...
export class AxiomaimVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'axiomaim-vertical-navigation-item-collapsed': this.isCollapsed,
            'axiomaim-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._axiomaimVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._axiomaimVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._axiomaimVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._axiomaimVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
