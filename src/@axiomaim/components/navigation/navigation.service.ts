...
export class AxiomaimNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, AxiomaimNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: AxiomaimNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): AxiomaimNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: AxiomaimNavigationItem[],
        flatNavigation: AxiomaimNavigationItem[] = []
    ...
    getItemParent(
        id: string,
        navigation: AxiomaimNavigationItem[],
        parent: AxiomaimNavigationItem[] | AxiomaimNavigationItem
    ): AxiomaimNavigationItem[] | AxiomaimNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
