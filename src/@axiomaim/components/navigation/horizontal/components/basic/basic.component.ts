...
@Component({
    selector: 'axiomaim-horizontal-navigation-basic-item',
...
export class AxiomaimHorizontalNavigationBasicItemComponent
    implements OnInit, OnDestroy
{
    ...
    isActiveMatchOptions: IsActiveMatchOptions =
        this._axiomaimUtilsService.subsetMatchOptions;
    ...
    ngOnInit(): void {
        ...
        this.isActiveMatchOptions =
            this.item.isActiveMatchOptions ?? this.item.exactMatch
                ? this._axiomaimUtilsService.exactMatchOptions
                : this._axiomaimUtilsService.subsetMatchOptions;
