...
import { AxiomaimHorizontalNavigationBasicItemComponent } from '@axiomaim/components/navigation/horizontal/components/basic/basic.component';
import { AxiomaimHorizontalNavigationDividerItemComponent } from '@axiomaim/components/navigation/horizontal/components/divider/divider.component';
...
@Component({
    selector: 'axiomaim-horizontal-navigation-branch-item',
    ...
    imports: [
        ...
        forwardRef(() => AxiomaimHorizontalNavigationBranchItemComponent),
        AxiomaimHorizontalNavigationDividerItemComponent,
        MatTooltipModule,
        MatIconModule,
    ],
})
export class AxiomaimHorizontalNavigationBranchItemComponent
