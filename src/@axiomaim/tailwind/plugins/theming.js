...
// -----------------------------------------------------------------------------------------------------
// @ AXIOMAIM TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `axiomaim.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `axiomaim.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--axiomaim-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--axiomaim-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
