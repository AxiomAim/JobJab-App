...
import { AxiomaimMockApiReplyCallback } from '@axiomaim/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class AxiomaimMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: AxiomaimMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: AxiomaimMockApiReplyCallback): void {
        // Store the reply
