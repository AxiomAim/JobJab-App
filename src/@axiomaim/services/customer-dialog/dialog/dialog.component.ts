...
@Component({
    selector: 'axiomaim-customer-dialog',
    templateUrl: './dialog.component.html',
    styles: [
        `
            .axiomaim-customer-dialog-panel {
                @screen md {
                    @apply w-128;
                }
...
export class AxiomaimCustomerDialogComponent {
readonly date = new FormControl(moment);
    data: AxiomaimCustomerConfig = inject(MAT_DIALOG_DATA);
